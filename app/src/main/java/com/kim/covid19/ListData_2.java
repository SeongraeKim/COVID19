...
public class ListData_2 implements Comparable<ListData_2>{
    private int tv_num;
    ...
    @Override
    public int compareTo(ListData_2 o) {
    ...
    public ListData_2(int tv_num, String tv_name, String tv_cases, String tv_cases_p, String tv_deaths, String tv_recovered){
        this.tv_num = tv_num;
